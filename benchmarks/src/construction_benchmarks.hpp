...
inline void run_default_onto_reserved_vector_benchmarks()
{
    ...
    bench.title("Default Construction onto Reserved Vector").warmup(100).performanceCounters(true);
...
{
    ankerl::nanobench::Bench bench;
    bench.title("Random Construction onto Reserved Vector").warmup(100).performanceCounters(true);
    bench.performanceCounters(true);
...
{
    ankerl::nanobench::Bench bench;
    bench.title("Copy Vector Benchmarks").warmup(100).performanceCounters(true);
    bench.performanceCounters(true);
