...
struct specializer_type_a : unit<specializer_type_a, std::ratio<1>>
{
};
struct specializer_type_b : unit<specializer_type_b, std::ratio<1>>
{
};

struct specializer_type_c : unit<specializer_type_c, std::ratio<1>>
{
};

struct specializer_type_d : unit<multiplied_dimensions_t<specializer_type_a, specializer_type_c>, std::ratio<1>>
{
};
